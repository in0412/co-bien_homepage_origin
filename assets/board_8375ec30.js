...
function photo_file2(mode, com_board_id,file_size)
{
	...
	form.action = '/chtml/board.php?template=bizdemo40260&com_board_basic=image_upload_mode&filemode=' + filemode + '&com_board_id=' + com_board_id+'&filesize='+photo_max_size;
	form.submit();
